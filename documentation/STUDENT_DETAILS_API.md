...
This document outlines the API endpoints for accessing detailed information about students in the AB Academy platform.

## Authentication

All endpoints require authentication with a valid access token.
