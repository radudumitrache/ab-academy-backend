...
| `generated_report` | string (HTML) | No | Full HTML correction report. Auto-generated by the MCP save_correction tool; teachers and admins may edit it manually. Rendered in the frontend as structured HTML. |
