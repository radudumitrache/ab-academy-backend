...
**Top-level `results` fields:**

| Field | Type | Notes |
|-------|------|-------|
| `submission_id` | integer | |
| `submitted_at` | string | ISO 8601 timestamp |
| `grade` | string\|null | Overall grade set by the teacher |
| `observation` | string\|null | Overall teacher feedback |
| `generated_report` | string\|null | Full HTML correction report generated by the AI grading tool. Render with `innerHTML` or an HTML renderer. `null` until correction has been run |
