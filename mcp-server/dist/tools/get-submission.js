...
exports.registerGetSubmission = registerGetSubmission;
const zod_1 = require("zod");
const api_client_js_1 = require("../api-client.js");
function registerGetSubmission(server, getToken) {
    server.tool('get_submission_details', `Fetch the full details of a student's homework submission, grouped by section.
...
- Listening sections with transcript: grade normally using transcript as context; without transcript: note "Audio transcript not available"`, {
        ...
        for (const section of sections) {
            const files = section.instruction_files ?? [];
...
//# sourceMappingURL=get-submission.js.map